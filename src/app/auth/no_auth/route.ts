...
// 20250919 demo 用の _no_auth で動作するように。
// 実証実験の時はこのディレクトリは見せない（消す？）ように
...
//    console.log('decryptToken:', decryptToken);
 ...
 //   }
    const  metawork_token = "__worker-token__" //, "kominkan-token" //decryptToken as ConnectedToken;
    const  virtual_kominkan_token =  "__kominkan-token__"
...
//  }
    ...
    const res = NextResponse.redirect(new URL("/cobotta/withDualCam/?type="+MetaworkType, url.origin));
